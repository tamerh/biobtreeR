...
# bbUseOutDir("/Users/tgur/Desktop/projects/biobtreeR/tmpp")
```
...
To simplfy previous use case query 3 builtin range query functions are provided. These functions are `overlaps`, `within` and `covers`. These functions can be used for `ensembl`, `transcript` and `exon`
